...
export const Cars: Car[] = [
  new Car(20, cord, details),
  new Car(40, cord1, details1),
  new Car(50, cord2, details2)
];

const premium_car = new Car(200,cord,details2)

// Додати авто до гаража
Cars.forEach((car) => garage.addVehicle(car));
app.addGarage(garage);
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <Routes>
          <Route
            path="/"
            element={<CarsList cars={cars} onRent={(car:Car) => {navigate('/rent')}} />}
          />
          <Route path="/add-garage" element={<AddGaragePage onAddGarage={addGarage} />} />
          <Route path="/add-car" element={<AddCarPage onAddCar={addCar} />} />
          <Route path="/map" element={<MapPage garages={garages} />} />
